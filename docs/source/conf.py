...
project = 'arXiv Compilation Service'
...
htmlhelp_basename = 'arXivCompilationServicedoc'
...
latex_documents = [
    (master_doc, 'arXivCompilationService.tex', 'arXiv Compilation Service Documentation',
...
man_pages = [
    (master_doc, 'arxivcompilationservice', 'arXiv Compilation Service Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'arXivCompilationService', 'arXiv Compilation Service Documentation',
     author, 'arXivCompilationService', 'One line description of project.',
     'Miscellaneous'),
]
